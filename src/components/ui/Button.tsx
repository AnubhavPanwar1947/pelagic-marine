...
export function Button({
  ...
  const classes = `btn-responsive inline-flex max-w-full items-center justify-center gap-2 rounded-full px-7 py-3.5 text-[15px] font-medium leading-none tracking-[0.02em] transition-all duration-300 ${variants[variant]} ${className}`;
