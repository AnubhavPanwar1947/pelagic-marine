            ...
            <>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p id={descId} className="type-copy mt-2">
              ...
              <div className="mt-5 grid gap-2 sm:grid-cols-3">
                <button
                  ...
                  className="rounded-full border border-pelagic-warm px-4 py-2.5 text-[15px] font-semibold text-pelagic-steel transition hover:border-pelagic-navy hover:text-pelagic-navy"
                >
                ...
                <button
                  ...
                  className="rounded-full border border-pelagic-navy/25 bg-pelagic-sky/60 px-4 py-2.5 text-[15px] font-semibold text-pelagic-navy transition hover:border-pelagic-accent"
                >
                  Customise
                </button>
                <button
                  type="button"
                  onClick={acceptAll}
                  className="rounded-full bg-pelagic-accent px-4 py-2.5 text-[15px] font-bold text-white shadow-md transition hover:bg-pelagic-light"
                >
                  Accept all
                </button>
              </div>
            ...
            <>
              ...
              <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
                <button
                  ...
                  className="rounded-full border border-pelagic-warm px-4 py-2.5 text-[15px] font-semibold text-pelagic-steel transition hover:border-pelagic-accent sm:mr-auto"
                >
                  Clear site cache
                </button>
                <button
                  ...
                  className="rounded-full border border-pelagic-warm px-4 py-2.5 text-[15px] font-semibold text-pelagic-steel transition hover:border-pelagic-navy"
                >
                  Back
                </button>
                <button
                  type="button"
                  onClick={saveCustom}
                  className="rounded-full bg-pelagic-accent px-5 py-2.5 text-[15px] font-bold text-white shadow-md transition hover:bg-pelagic-light"
                >
                  Save preferences
                </button>
              </div>
